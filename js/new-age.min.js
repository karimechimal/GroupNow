...
$(document).ready(function() {
    ...
    $("#signup").on("click", function(event) {
        ...
        setTimeout(function() { window.location = "index1.html" }, 1000);
...
console.log(Place);
var queryURL = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=restaurants+in+" + Place +"&key=AIzaSyAEKLmQaNvUhPtuXE4CaybDZ0wVBa5kVqU";
